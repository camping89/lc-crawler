...
public static class GenericExtensions
    {
        ...
        {
            return StringExtensions.IsNotNullOrEmpty(obj) ? getter(obj) : valueIfNotPoss;
        }
        ...
        public static string GetAggregateExceptionMessage(this AggregateException ae)
        {
            ...
            foreach (var exInnerException in ae.Flatten().InnerExceptions)
            {
                ...
                do
                {
                    if (StringExtensions.IsNotNullOrEmpty(exNestedInnerException.Message)) exceptionMessage += exNestedInnerException.Message + "\n";
